...
ggplot() +
  ...
  labs(title = "Impact of Water Treatment and Plant Species on Total Biomass",
       x = "Water Treatment",
...
## Part d
This figure shows the predicted (darker points) and underlying data (lighter points) of water treatment changes and varying plant species on total plant biomass. Each plot represents a different species' data, all having well watered (orange) and drought stressed (blue) on the x-axis and total biomass (in grams) on the y-axis. The error bars represent a 95% confidence interval for the predicted values of each species. 
...
## Part e
Model 4, the best model and shown above in the figure, has the predictors of water treatment and plant species, both of which best describe total mass. Model 4 has the lowest AIC value (AIC = -156.2) of all the models and a delta of 0, suggesting it is the best and significant model (F(7,62) = 27.08, p<0.001, a=0.05, adjusted R^2=0.73). On average between water treatments, those that were well watered tended to have a higher total biomass than those that were drought stressed. Grindelia camporum was the species with the highest total biomass for both well watered and drought stressed treatments, however all species had around the same amount of total biomass on average. 
